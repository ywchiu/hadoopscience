package com.largitdata.mahouttutorial;
...
public class App 
{
    ...
    static final String inputFile = “/user/cloudera/mldata/ratings.dat";
    static final String outputFile = “/user/cloudera/mldata/ratings.csv";
